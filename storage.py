...
class DataStore:
    ...
    async def save(self) -> None:
        ...
        async with self._write_lock:
            try:
                # Use aiofiles to avoid blocking the event loop on file writes
                async with aiofiles.open(self._data_file, "w", encoding="utf-8") as fh:
                    content = json.dumps(self.db, indent=2, default=str)
